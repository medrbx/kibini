...
my $r6 = "UPDATE statdb.stat_issues i JOIN koha_prod.old_issues o ON i.cle = o.cle SET i.returndate = o.returndate, i.renewals = o.renewals WHERE i.returndate IS NULL AND DATE(o.returndate) = CURDATE() - INTERVAL 1 DAY" ; 
