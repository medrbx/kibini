...
open(my $fd_out,">:encoding(utf8)","statArteVodWithData.csv");
my @column_names = qw( arte_date_inscription arte_derniere_mise_a_jour arte_derniere_connexion arte_abonnement_valide arte_abonnement_en_cours arte_nb_consommations sexe ages_lib1 ages_lib2 ages_lib3 geo_ville geo_ville_front geo_roubaix_iris geo_roubaix_nom_iris geo_roubaix_quartier geo_gentile inscription_personnalite inscription_carte inscription_type_carte inscription_site_inscription inscription_gratuite inscription_prix inscription_fidelite inscription_fidelite_tr activite_emprunteur activite_emprunteur_med activite_emprunteur_bus activite_utilisateur_postes_informatiques activite_utilisateur_wifi activite_salle_etude activite inscription_attribut nb_venues nb_venues_tr nb_venues_prets nb_venues_prets_tr nb_venues_prets_mediatheque nb_venues_prets_mediatheque_tr nb_venues_prets_bus nb_venues_prets_bus_tr nb_venues_postes_informatiques nb_venues_postes_informatiques_tr nb_venues_wifi nb_venues_wifi_tr nb_venues_salle_etude nb_venues_salle_etude_tr );
