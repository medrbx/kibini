...
sub exemplaires {
    ...
    open(my $fd,">:encoding(utf8)","../data/collections/2023_exemplaires_$nom_fichier.csv") ;
...
FROM koha2023.items i
JOIN koha2023.biblioitems bi ON bi.biblionumber = i.biblionumber
...
sub prets {
    ...
    open(my $fd,">:encoding(utf8)","../data/collections/2023_prets_$nom_fichier.csv") ;
    my @column_names = qw( collection_code support nb_prets_2021 nb_prets_2021_exemplaires_distincts nb_prets_2021_emprunteurs_distincts nb_prets_2022 nb_prets_2022_exemplaires_distincts nb_prets_2022_emprunteurs_distincts nb_prets_2023 nb_prets_2023_exemplaires_distincts nb_prets_2023_emprunteurs_distincts) ;
    $csv->print ($fd, \@column_names) ;
...
sub eliminations {
    ...
    open(my $fd,">:encoding(utf8)","../data/collections/2023_eliminations_$nom_fichier.csv") ;
