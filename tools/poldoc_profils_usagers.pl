...
foreach my $site (@sites) {
	...
	my $file_out = "/home/kibini/kibini_prod/data/collections/poldoc_profils_usagers_out_2019_" . $site->{nom_fichier} . "_totaux.csv";
...
sub getWhereClause {
	...
	$where = "WHERE YEAR(iss.issuedate) = 2019 AND " . $whereLocation . " AND " . $where;
