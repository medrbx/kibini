...
sub prets {
    ...
    open(my $fd,">:encoding(utf8)","../data/collections/2020_prets_$nom_fichier.csv") ;
    my @column_names = qw( collection_code support nb_prets_2018 nb_prets_2018_exemplaires_distincts nb_prets_2018_emprunteurs_distincts nb_prets_2019 nb_prets_2019_exemplaires_distincts nb_prets_2019_emprunteurs_distincts nb_prets_2020 nb_prets_2020_exemplaires_distincts nb_prets_2020_emprunteurs_distincts) ;
    $csv->print ($fd, \@column_names) ;
...
sub eliminations {
    ...
    open(my $fd,">:encoding(utf8)","../data/collections/2020_eliminations_$nom_fichier.csv") ;
