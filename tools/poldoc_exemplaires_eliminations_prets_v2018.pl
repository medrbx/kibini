...
sub exemplaires {
    ...
    open(my $fd,">:encoding(utf8)","../data/collections/2018_exemplaires_v2_$nom_fichier.csv") ;
...
sub prets {
    ...
    open(my $fd,">:encoding(utf8)","../data/collections/2018_prets_$nom_fichier.csv") ;
...
sub eliminations {
    ...
    open(my $fd,">:encoding(utf8)","../data/collections/2018_eliminations_$nom_fichier.csv") ;
