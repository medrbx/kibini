...
sub exemplaires {
    ...
    open(my $fd,">:encoding(utf8)","../data/collections/2025_exemplaires_$nom_fichier.csv") ;
...
SELECT
	...
	COUNT(IF(i.notforloan IN (0, 2) AND i.damaged = 0 AND i.itemlost = 0 AND i.location NOT IN ('MED0A', 'MED2C', 'MED2D', 'MED3C', 'MED3D', 'MED3E', 'MED3F', 'MED3G', 'MED3H', 'MED3I', 'MED3J', 'MED3K', 'MED3L', 'MED3M', 'MED3N', 'MED3O', 'MED3P', 'MED3Q', 'MED3R', 'MED3S', 'MED3T' ), i.itemnumber, NULL)) AS 'nb_exemplaires_en_acces_libre',
    COUNT(IF(i.notforloan IN (0, 2) AND i.damaged = 0 AND i.itemlost = 0 AND i.location IN ('MED0A', 'MED2C', 'MED2D', 'MED3C', 'MED3D', 'MED3E', 'MED3F', 'MED3G', 'MED3H', 'MED3I', 'MED3J', 'MED3K', 'MED3L', 'MED3M', 'MED3N', 'MED3O', 'MED3P', 'MED3Q', 'MED3R', 'MED3S', 'MED3T' ), i.itemnumber, NULL)) AS 'nb_exemplaires_en_acces_indirect',
    ...
    COUNT(IF(i.dateaccessioned > ('2026-01-01' - INTERVAL 1 YEAR), i.itemnumber, NULL)) AS 'nb_exemplaires_créés_dans_annee',
	COUNT(IF(i.notforloan NOT IN (-2, -1, 2) AND i.datelastborrowed <= ('2026-01-01' - INTERVAL 1 YEAR), i.itemnumber, NULL)) AS 'nb_exemplaires_empruntables_pas_empruntés_1_an',
    COUNT(IF(i.notforloan NOT IN (-2, -1, 2) AND i.datelastborrowed <= ('2026-01-01' - INTERVAL 3 YEAR), i.itemnumber, NULL)) AS 'nb_exemplaires_empruntables_pas_empruntés_3_ans',
    COUNT(IF(i.onloan IS NOT NULL OR i.itemlost = 1, i.itemnumber, NULL)) AS 'nb_exemplaires_en_pret'
FROM koha2025.items i
JOIN koha2025.biblioitems bi ON bi.biblionumber = i.biblionumber
...
sub prets {
    ...
    open(my $fd,">:encoding(utf8)","../data/collections/2025_prets_$nom_fichier.csv") ;
    my @column_names = qw( collection_code support nb_prets_2023 nb_prets_2023_exemplaires_distincts nb_prets_2023_emprunteurs_distincts nb_prets_2024 nb_prets_2024_exemplaires_distincts nb_prets_2024_emprunteurs_distincts nb_prets_2025 nb_prets_2025_exemplaires_distincts nb_prets_2025_emprunteurs_distincts) ;
    $csv->print ($fd, \@column_names) ;
...
SELECT
    i.ccode,
	i.itemtype,
	COUNT(IF(YEAR(i.issuedate) = 2023, i.itemnumber, NULL)) AS 'nb_prets_2023',
	COUNT(DISTINCT(IF(YEAR(i.issuedate) = 2023, i.itemnumber, NULL))) AS 'nb_prets_2023_exemplaires_distincts',
	COUNT(DISTINCT(IF(YEAR(i.issuedate) = 2023, i.borrowernumber, NULL))) AS 'nb_prets_2023_emprunteurs_distincts',
	COUNT(IF(YEAR(i.issuedate) = 2024, i.itemnumber, NULL)) AS 'nb_prets_2024',
	COUNT(DISTINCT(IF(YEAR(i.issuedate) = 2024, i.itemnumber, NULL))) AS 'nb_prets_2024_exemplaires_distincts',
	COUNT(DISTINCT(IF(YEAR(i.issuedate) = 2024, i.borrowernumber, NULL))) AS 'nb_prets_2024_emprunteurs_distincts',
	COUNT(IF(YEAR(i.issuedate) = 2025, i.itemnumber, NULL)) AS 'nb_prets_2025',
	COUNT(DISTINCT(IF(YEAR(i.issuedate) = 2025, i.itemnumber, NULL))) AS 'nb_prets_2025_exemplaires_distincts',
	COUNT(DISTINCT(IF(YEAR(i.issuedate) = 2025, i.borrowernumber, NULL))) AS 'nb_prets_2025_emprunteurs_distincts'
...
sub eliminations {
    ...
    open(my $fd,">:encoding(utf8)","../data/collections/2025_eliminations_$nom_fichier.csv") ;
